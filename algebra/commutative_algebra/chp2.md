...
从germ的意义下来说，两个形如$\frac{f_1}{u_1}$和$\frac{f_2}{u_2}$的函数等价，等于说存在一个更小的邻域，假设其余集是函数u的零点集，使得$u (\frac{f_1}{u_1} - \frac{f_2}{u_2}) = 0$，这等价于$u(f_1 u_2 - f_2 u_1) = 0$，这和局部化意义下两个分数是等价的是一致的。
